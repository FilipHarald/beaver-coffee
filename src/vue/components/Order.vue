      ...
      <div class="card-content">
        <form action="">
          ...
          <div class="field">
            <div class="control">
              <ul>
                <li class="tag" style="display: flex; width: 100%; justify-content: flex-start;">Tag 1 <button class="delete is-small" style="margin-left: auto"></button></li>
              </ul>
            </div>
          </div>
          ...
          <div class="field">
            <div class="control">
              <button href="#" class="button is-default is-fullwidth">Clear fields</button>
            </div>
          </div>

          <div class="field">
            <div class="control">
              <button href="#" type="submit" class="button is-success is-fullwidth" id="btn_place_order">Place order</button>
            </div>
          </div>
        </form>
